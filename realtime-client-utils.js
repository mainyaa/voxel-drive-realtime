 ...
 */
rtclient.Authorizer.prototype.start = function(onAuthComplete, onAuthFailure) {
  var _this = this;
  gapi.load('auth:client,drive-realtime,drive-share', function() {
    _this.authorize(onAuthComplete, onAuthFailure);
  });
}
 ...
 * @param onAuthComplete {Function} to call once authorization has completed.
 */
rtclient.Authorizer.prototype.authorize = function(onAuthComplete, onAuthFailure) {
 ...
 */
rtclient.RealtimeLoader.prototype.start = function(afterAuth, onAuthFailure) {
